...
navigator.customGetUserMediaBar = function (session, success_callback, failure_callback) {
    ...
    overlay.setAttribute('style', 'background: rgba(255, 255, 255, 0.66);position: fixed;top: 0;left: 0;width: 100%;height: 100%;');
    ...
    var buttonSyles = 'font-size: 14px;font-family: ' + parentFontFamily + ';font-weight: normal;border-radius: 3px;border: 1px solid #7C7777;padding: 4px 12px;text-decoration: none;background: -webkit-gradient( linear, left top, left bottom, color-stop(5%, #D6D3D3), color-stop(100%, #FFFFFF) );background-color: #ededed;color: #1B1A1A;display: inline-block;box-shadow: inset 1px 1px 0px 0px #ffffff;text-shadow: none;';
