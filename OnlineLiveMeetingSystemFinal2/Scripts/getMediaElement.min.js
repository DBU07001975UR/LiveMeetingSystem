function getMediaElement(e, t) {
    function E() {
        s.style.marginLeft = i.clientWidth - s.clientWidth - 2 + "px"; if (d) {
    ...
    if (r.has("mute-audio")) {
        ...
        o.onclick = function () {
            if (o.className.indexOf("unmute-audio") != -1) {
                ...
                e.muted = false; e.volume = 1; if (t.onUnMuted) t.onUnMuted("audio")
            } else {
    ...
    if (r.has("take-snapshot")) {
        ...
        s.appendChild(a); a.onclick = function () {
    ...
    if (r.has("record-video")) {
        ...
        l.appendChild(h); h.onclick = function () {
    ...
    if (r.has("full-screen")) {
        var v = document.createElement("div"); v.className = "control " + (t.toggle.has("zoom-in") ? "zoom-out selected" : "zoom-in");
        if (!d && !c && !h && v) {
    ...
    i.appendChild(b); b.appendChild(e);
    if (!t.width)
        t.width = innerWidth / 2 - 50; i.style.width = t.width + "px";
        if (t.height) {
            b.style.height = t.height + "px"
        } b.querySelector("video").style.maxHeight = innerHeight + "px"; var w = 0;
        if (t.showOnMouseEnter || typeof t.showOnMouseEnter === "undefined") {
            i.onmouseenter = i.onmousedown = function () {
                E(); s.style.opacity = 1; l.style.opacity = 1
            }; i.onmouseleave = function () {
                s.style.opacity = 0; l.style.opacity = 0
            }
        } else {
            setTimeout(function () {
                E(); setTimeout(function () {
                    s.style.opacity = 1; l.style.opacity = 1
                }, 300)
            }, 700)
        } E(); i.toggle = function (e) {
            if (typeof e != "string") {
...
function getAudioElement(e, t) {
    ...
    if (!e.nodeName || e.nodeName.toLowerCase() != "audio" && e.nodeName.toLowerCase() != "video") {
        ...
        e[!!navigator.mozGetUserMedia ? "mozSrcObject" : "src"] = !!navigator.mozGetUserMedia ? n : window.webkitURL.createObjectURL(n)
    } t.toggle = t.toggle || []; t.toggle.has = function (e) {
        return t.toggle.indexOf(e) !== -1
    }; e.controls = false; e.play();
    var r = document.createElement("div");
    r.className = "media-container";
    var i = document.createElement("div");
    i.className = "media-controls"; r.appendChild(i);
    var s = document.createElement("div");
    ...
    s.onclick = function () {
        ...
        var o = document.createElement("div"); o.className = "control " + (t.toggle.has("record-audio") ? "stop-recording-audio selected" : "record-audio"); i.appendChild(o); o.onclick = function () {
    ...
    if (t.buttons && t.buttons.indexOf("record-audio") == -1) {
        a.style.width = " 241px"
    } a.type = "range"; a.min = 0; a.max = 100; a.value = 100; a.onchange = function () {
    ...
    f.onclick = function () {
        ...
        }, 800); if (t.onStopped) t.onStopped()
    };
    ...
    l.appendChild(c);
    l.appendChild(e); r.style.width = "329px";
    l.style.height = "90px"; c.style.width = r.style.width; c.style.height = "50px"; c.style.overflow = "hidden"; var h = 0;
    if (t.showOnMouseEnter || typeof t.showOnMouseEnter === "undefined") {
        r.onmouseenter = r.onmousedown = function () {
            p(); i.style.opacity = 1
        }; r.onmouseleave = function () { i.style.opacity = 0 }
    } else {
        setTimeout(function () { p(); setTimeout(function () { i.style.opacity = 1 }, 300) }, 700)
    } p(); r.toggle = function (e) {
        if (typeof e != "string") {
            for (var t = 0; t < e.length; t++) {
                r.toggle(e[t])
            } return
...
document.write('<link rel="stylesheet" href="GetmediaElement/getMediaElement.css">')